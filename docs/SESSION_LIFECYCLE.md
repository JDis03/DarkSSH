...
**First action:**
- Call `memory_start_session(cwd="/home/dark/Project/clientssh")` to load project context
...
- Call `memory_get_todos(cwd="/home/dark/Project/clientssh")` to list pending tasks ordered by priority
...
- Call `memory_add_decision(decision, rationale, cwd="/home/dark/Project/clientssh")` when choosing between approaches
- Call `memory_add_learning(lesson, context, cwd="/home/dark/Project/clientssh")` when discovering something useful
- Call `memory_add_todo(task, priority, cwd="/home/dark/Project/clientssh")` for out-of-scope work found during implementation
...
3. Call `memory_end_session(summary, completed_todos=[], verified="ran init.sh", cwd="/home/dark/Project/clientssh")`
