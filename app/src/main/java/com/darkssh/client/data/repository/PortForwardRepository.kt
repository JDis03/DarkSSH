...
class PortForwardRepository
    ...
    constructor(
        ...
        fun getPortForwardsByHostId(hostId: Long): Flow<List<PortForward>> = portForwardDao.getByHostId(hostId)

        suspend fun insertPortForward(portForward: PortForward): Long = portForwardDao.insert(portForward)
