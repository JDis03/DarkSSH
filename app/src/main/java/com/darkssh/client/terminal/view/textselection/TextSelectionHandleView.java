...
import com.darkssh.client.terminal.view.support.PopupWindowCompatGingerbread;
...
public class TextSelectionHandleView extends View {
    ...
    public TextSelectionHandleView(TerminalView terminalView, CursorController cursorController, int initialOrientation) {
        ...
        mHandleLeftDrawable = getContext().getDrawable(com.darkssh.client.R.drawable.text_select_handle_left_material);
        mHandleRightDrawable = getContext().getDrawable(com.darkssh.client.R.drawable.text_select_handle_right_material);
