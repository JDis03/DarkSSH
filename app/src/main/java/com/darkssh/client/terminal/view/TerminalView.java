package com.darkssh.client.terminal.view;
...
import com.darkssh.client.terminal.emulator.KeyHandler;
import com.darkssh.client.terminal.emulator.TerminalEmulator;
import com.darkssh.client.terminal.emulator.TerminalSession;
import com.darkssh.client.terminal.view.textselection.TextSelectionCursorController;
...
public final class TerminalView extends View {
        ...
        mGestureRecognizer = new GestureAndScaleRecognizer(context, new GestureAndScaleRecognizer.Listener() {
            ...
            public boolean onScroll(MotionEvent e, float distanceX, float distanceY) {
                ...
                if (mEmulator.isMouseTrackingActive() && e.isFromSource(InputDevice.SOURCE_MOUSE)) {
                    ...
                    // When scrolling vertically, prevent parent (HorizontalPager) from intercepting
                    // the gesture and accidentally switching tabs mid-scroll.
     ...
     * {@link com.darkssh.client.terminal.emulator.TerminalSessionClient#onTerminalCursorStateChange(boolean)}
