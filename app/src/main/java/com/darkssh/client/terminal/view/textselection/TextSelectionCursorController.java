package com.darkssh.client.terminal.view.textselection;
...
import com.darkssh.client.terminal.emulator.TerminalBuffer;
import com.darkssh.client.terminal.emulator.WcWidth;
    ...
    public void setActionModeCallBacks() {
        final ActionMode.Callback callback = new ActionMode.Callback() {
            ...
            public boolean onCreateActionMode(ActionMode mode, Menu menu) {
                ...
                menu.add(Menu.NONE, ACTION_COPY, Menu.NONE, com.darkssh.client.R.string.copy_text).setShowAsAction(show);
                menu.add(Menu.NONE, ACTION_PASTE, Menu.NONE, com.darkssh.client.R.string.paste_text).setEnabled(clipboard != null && clipboard.hasPrimaryClip()).setShowAsAction(show);
                menu.add(Menu.NONE, ACTION_MORE, Menu.NONE, com.darkssh.client.R.string.text_selection_more);
                return true;
            }
